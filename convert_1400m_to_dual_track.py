"""
Convert pretrained Mamba-1.4B to dual-track architecture
"""
...
def main():
    print("="*60)
    print("Converting Mamba-1.4B to Dual-Track Architecture")
    print("="*60)
    
    # Load pretrained model
    print("\n1. Loading pretrained Mamba-1.4B...")
    ...
    import os
    save_path = "checkpoints/dual_track_1400m_init"
