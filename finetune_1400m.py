"""
Fine-tune pretrained Mamba-1.4B on narrative continuation task
"""
...
def main():
    ...
    # Hyperparameters
    batch_size = 1  # Must be 1 for 1.4B model on 32GB
    accumulation_steps = 2  # Effective batch size = 2
    learning_rate = 1e-4
    num_epochs = 10
    max_length = 1024
    
    save_dir = 'checkpoints/finetuned_1400m'
    os.makedirs(save_dir, exist_ok=True)
    
    # Load pretrained 1.4B model
    print("Loading pretrained Mamba-1.4B...")
    ...
    print(f"\n{'='*60}")
    print(f"Fine-tuning Mamba-1.4B for {num_epochs} epochs")
