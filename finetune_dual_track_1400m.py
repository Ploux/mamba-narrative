"""
Fine-tune dual-track Mamba-1.4B on narrative continuation task
"""
...
def main():
    log_file = 'finetune_dual_track_1400m.log'
    ...
    # Hyperparameters - same as baseline 1.4B
    batch_size = 1
    ...
    save_dir = 'checkpoints/finetuned_dual_track_1400m'
    os.makedirs(save_dir, exist_ok=True)
    
    # Load dual-track model
    print("Loading dual-track Mamba-1.4B...")
    checkpoint = torch.load('checkpoints/dual_track_1400m_init/model.pt')
    ...
    # Optimizer with 8-bit optimization to save memory
    ...
    print(f"\n{'='*60}")
    print(f"Fine-tuning Dual-Track Mamba-1.4B for up to {num_epochs} epochs")
    ...
    print(f"Estimated time per epoch: ~35-45 minutes")
    print(f"{'='*60}\n")
